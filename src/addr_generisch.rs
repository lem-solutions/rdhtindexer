...
pub trait Addr : smol::net::AsyncToSocketAddrs + Into<SocketAddr> + std::fmt::Display + Clone + PartialEq + Hash {
...
impl Addr for SocketAddrV4 {
	...
	*/
	...
	fn global_valide(&self) -> bool { true }
...
impl Addr for SocketAddrV6 {
	...
	*/
	...
	fn aus_krpc_bytes(bytes: &[u8]) -> Option<Self> {
		...
		let port = u16::from_be_bytes(port_bytes);
		Some(SocketAddrV6::new(Ipv6Addr::from_octets(ip_bytes), port, 0, 0))
	}
